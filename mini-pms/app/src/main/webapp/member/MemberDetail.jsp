...
<form id="member-form" action='update' method='post' enctype='multipart/form-data'>
	<div class="mb-3 row">
		...
		<div class="col-sm-6">
			<input id='f-no' type='text' name='no' class="form-control"
	...
	<div class="mb-3 row">
		...
		<div class="col-sm-10">
			<input id='f-registeredDate' type="text" readonly
				class="form-control-plaintext" value="${member.registeredDate}">
		</div>
	</div>
	<button class="btn btn-primary">변경</button>
	<a href='delete?no=${member.no}' class="btn btn-primary">삭제</a> <a
		href='list' class="btn btn-primary">목록</a><br>
</form>
